...
class TestCEM_MAFImageExplainer(unittest.TestCase):
    ...
    def test_CEM_MAFExplainer(self):
        ...
        with tf.Session() as sess: # Open TensorFlow Session
            ...
            arg_img_name = os.path.join(local_path_img, f"{img_id}_img.png")
            print(f"Image:{arg_img_name}, pred:{orig_class}")
            print(f"Male:{sex_flag}, Smile:{smile_flag}, Young:{young_flag}")
            ...
            print(f"Pertinent positive pred:{adv_class}")
            print(f"Male:{sex_flag}, Smile:{smile_flag}, Young:{young_flag}")
